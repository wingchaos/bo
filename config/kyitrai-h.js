...
/* No other configuration options beyond this point. */
    ...
    function update(e) {
        ...
        Overlay.EncounterElem.find("span.tdps").text(encdps ? encdps : "---");
        Overlay.EncounterElem.find("span.time").text(encData.duration);
		Overlay.EncounterElem.find("span.tdmg").text(encData.damage);
		Overlay.EncounterElem.find("span.deaths").text(encData.deaths);
        ...
        $.each(cmbData, function(k, combatant) {
            ...
            elem.find("span.heal").text(combatant['healed%']);
			elem.find("span.healcrit").text(combatant['critheal%']);
            elem.find("span.overheal").text(combatant.OverHealPct);
			elem.find("span.maxheal").text(combatant.maxheal);
            elem.find("div.bar")
